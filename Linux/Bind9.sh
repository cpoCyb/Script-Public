## Creation DNS 1 zone pour 1 serveur web

## NE PAS LANCER LE SCRIPT EN SSH


## Supprimer les fichier a reecrire
...
## Demande info ip du serveur DNS a creer
...
## Creation du fichier configuration internet
...
## Creation du fichier configuration Resolv.conf
...
## Creation du fichier configuration des zones
